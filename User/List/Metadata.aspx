<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPage.master" AutoEventWireup="true" CodeFile="Metadata.aspx.cs" Inherits="User_List_Metadata" %>
                ...
                <asp:Panel runat="server" CssClass="portlet-body ">
                    ...
                    <dx:ASPxTreeList ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:TreeListComboBoxColumn Caption="Anlayışın adı" FieldName="list_id" ReadOnly="true" VisibleIndex="2" Width="100">
