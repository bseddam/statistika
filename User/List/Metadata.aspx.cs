...
public partial class User_List_Metadata : System.Web.UI.Page
{
    ...
    void _loadGridFromDb()
    {
        ...
        dt = _db.GetMetaData(Indicator.Value.ToParseInt());
    ...
    protected void _loadIndicators()
    {

        DataTable dtGoals = _db.GetIndicatorsByOrgId(DALC.UserInfo.OrgId);
