<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="User_Footnotes_Default" %>
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn Caption="Qeydin məzmunu" FieldName="name">
                                <EditFormSettings VisibleIndex="0" ColumnSpan="4" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataMemoColumn Caption="İzah (AZ)" FieldName="desc_az">
                                <EditFormSettings VisibleIndex="2" ColumnSpan="4" />
                            </dx:GridViewDataMemoColumn>
                            <dx:GridViewDataMemoColumn Caption="İzah (EN)" FieldName="desc_en">
                                <EditFormSettings VisibleIndex="2" ColumnSpan="4" />
                            </dx:GridViewDataMemoColumn>
                            <dx:GridViewCommandColumn ShowNewButtonInHeader="true" Width="200" HeaderStyle-CssClass="treelist-new-column">
