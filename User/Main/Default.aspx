<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="User_Main_Default" %>
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn Caption="Göstəricinin kodu" FieldName="code" VisibleIndex="2">
                                <DataItemTemplate>
                                    <%#Config.ClearIndicatorCode( Eval("code").ToParseStr())%>
                                </DataItemTemplate>
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn Caption="Göstəricinin adı" FieldName="name_az" VisibleIndex="2">
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn Caption="Ölçü vahidi" FieldName="SizeName" VisibleIndex="2">
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataComboBoxColumn Caption="Hesabatlılıq vəziyyəti" FieldName="FillCount" VisibleIndex="2"
                                Settings-AllowAutoFilter="true">
                                <PropertiesComboBox>
                                    <Items>
                                        <dx:ListEditItem Text="Bütün məlumatlar" Value="" />
                                        <dx:ListEditItem Text="Məlumat daxil edilib" Value="1" />
                                        <dx:ListEditItem Text="Məlumat daxil edilməyib" Value="0" />
                                    </Items>
                                </PropertiesComboBox>
                            </dx:GridViewDataComboBoxColumn>

                            <dx:GridViewDataColumn Caption="Cari məlumatların bazaya daxil olunması" Width="200" VisibleIndex="7">
                                <DataItemTemplate>
                                    <%# GetStr(
                                                Eval("teqdim_olunma_bas_gun").ToParseInt(),
                                                Eval("teqdim_olunma_bas_ay").ToParseInt(),
                                                Eval("teqdim_olunma_son_gun").ToParseInt(),
                                                Eval("teqdim_olunma_son_ay").ToParseInt(),
                                                Eval("elave_gun").ToParseInt(),
                                                Eval("id").ToParseInt()
                                    )
                                    %>
                                </DataItemTemplate>
                        ...
                        <SettingsPager SEOFriendly="Disabled">
