<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecoverPass.aspx.cs" Inherits="User_RecoverPass" %>
                            ...
                            <asp:View runat="server">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-icon">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1"
                                            ...
                                            ErrorMessage="-Yeni şifrə daxil edin">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-icon">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                                            ...
                                            ErrorMessage="-Yeni şifrə təkrar daxil edin">
                                        </asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <asp:CompareValidator ID="CompareValidator1"
                                        ...
                                        ErrorMessage="-Yeni şifrə və təkrarı eyni deyil">
                            ...
                            <asp:View runat="server">
                                <div class="form-group">
                                    ...
                                    <div style="color: #fff">
                                        ...
                                        <br />
                                        <p>
                                            Şifrə uğurla dəyişdirildi. Sistemə daxil ola bilərsiniz.
                                            <a href="/user/default.aspx" style="color: #fff; text-decoration: underline; font-style: italic;">keçid
                                            </a>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <asp:View runat="server">
                                <div class="form-group">
                                    ...
                                    <div style="color: #fff">
                                        ...
                                        <br />
                                        <p>
                                            İstifadə etdiyiniz keçidin isdifadə müddəti bitmişdir. 
                                            Şifrəni yeniləmək üçün yenidən cəhd edin.
                                            <a href="/user/forgotpass.aspx" style="color: #fff; text-decoration: underline; font-style: italic;">keçid
                                            </a>
                                        </p>
                                    </div>
                                </div>
