                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataComboBoxColumn Caption="Göstərici" FieldName="indicator_id" VisibleIndex="2">
                            </dx:GridViewDataComboBoxColumn>

                            <dx:GridViewDataComboBoxColumn Caption="Region" FieldName="region_id" VisibleIndex="2">
                            </dx:GridViewDataComboBoxColumn>
                              <dx:GridViewDataColumn Caption="Dəyər" FieldName="value" VisibleIndex="2">
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn Caption="Il" FieldName="year" VisibleIndex="2">
                            </dx:GridViewDataColumn>
