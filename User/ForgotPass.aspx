<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ForgotPass.aspx.cs" Inherits="User_ForgotPass" %>
...
<head runat="server">
    ...
    <link href="/user/assets/admin/pages/css/blog.css" rel="stylesheet" />
    <link href="/user/assets/global/plugins/select2/select2.css" rel="stylesheet" type="text/css" />
    <link href="/user/assets/admin/pages/css/login-soft.css" rel="stylesheet" type="text/css" />
    ...
    <link id="style_color" href="/user/assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css" />
    <link href="/user/assets/admin/layout/css/custom.css" rel="stylesheet" type="text/css" />
    <!-- my css -->
    <link href="/user/assets/admin/pages/css/custom.css" rel="stylesheet" />
    <!-- END THEME STYLES -->
...
<body class="login">
    <form id="form1" runat="server">
            ...
            <ContentTemplate>
                <asp:Panel ID="Panel1" runat="server" DefaultButton="LnkEnter">
                    <div class="content" style="height: 350px">
                        ...
                        <asp:MultiView ID="MyView" ActiveViewIndex="0" runat="server">
                            <asp:View runat="server">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label ">
                                        Qurumun kodunu daxil edin
                                    </label>
                                    <div class="input-icon">
                                        <i class="fa fa-user"></i>
                                        <asp:TextBox ID="UserLogin" runat="server" CssClass="form-control placeholder-no-fix"
                                            MaxLength="50" placeholder="Qurumun kodu"></asp:TextBox>
                                    </div>
                                    <div style="margin-top: 5px; font-size: 10px; color: #fff; font-style: italic;">
                                        Qeydiyyatdan keçərkən isdifadə etdiyiniz e-poçt 
                                ünvanına parolunuzu bərpa etmək üçün link göndəriləcək
                                    </div>
                                </div>
                                ...
                                <div id="actions" class="form-actions">
                                    ...
                                    <div class="col-md-12" style="padding: 0;">
                                        <asp:LinkButton ID="LnkEnter" runat="server" CssClass="btn blue pull-right" Style="background-color: #229DA5" OnClick="LnkEnter_Click"
                                            ...
                                            Width="100%">
                                Təsdiqlə <i class="m-icon-swapright m-icon-white"></i></asp:LinkButton>
                                    </div>
                            ...
                            <asp:View runat="server">
                                <div class="form-group">
                                    ...
                                    <div style="color: #fff">
                                       <h3>Uğurla tamamlandı!</h3> 
                                       <br />
                                        <p>Qeydiyyatdan keçərkən isdifadə etdiyiniz e-poçt 
                                             ünvanına parolunuzu bərpa etmək üçün link göndərildi</p>  
                                    </div>
                                </div>
                            </asp:View>
                        </asp:MultiView>
        ...
        <!-- BEGIN CORE PLUGINS -->
        <!--[if lt IE 9]>
<script src="/user/assets/global/plugins/respond.min.js"></script>
<script src="/user/assets/global/plugins/excanvas.min.js"></script> 
<![endif]-->
        <script>
        ...
        <script src="/user/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
        <script src="/user/assets/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
        ...
        <script>
            jQuery(document).ready(function () {
                ...
                $.backstretch([
                 "/user/assets/admin/pages/media/bg/111.jpg",
                 //"/user/assets/admin/pages/media/bg/411.jpg"
                ], {
                    fade: 1000,
                    duration: 8000
                }
