<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Order.aspx.cs" Inherits="WebPages_Order" %>
                        ...
                        <div class="news-content" style="border-right: unset; padding-top: 10px;">
                            <ul>
                                <asp:Repeater ID="rptNews" runat="server">
                                    <ItemTemplate>
                                        <li>
                                            <a href="<%#"/"+Config.getLang(Page)+"/order/"+Eval("id") %>">
                    ...
                    <div class="borderAll paddingLR10 ">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="content-date" style="display:none">
