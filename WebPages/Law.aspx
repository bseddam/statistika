<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Law.aspx.cs" Inherits="WebPages_Law" %>
                                ...
                                <asp:Repeater ID="rptGoals" runat="server">
                                    <ItemTemplate>
                                        <li class="<%#Eval("id").ToParseStr()==Page.RouteData.Values["pageid"].ToParseStr()?"active":"" %>">
                                            <a href="<%#string.Format("/{0}/law/{1}/{2}",Config.getLang(Page),Eval("id"),Config.Slug(Eval("name_"+Config.getLang(Page)).ToParseStr())) %>">
