<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="NationalPriority.aspx.cs" Inherits="WebPages_NationalPriority" %>
                ...
                <div class="col-md-8">
                    <div class="borderAll paddingLR10">
                        ...
                        <div class="goal-info-container">
                            <asp:Literal ID="lblGoalContent" Text="" runat="server" />
                        </div>
                        <div class="goal-info-tab-container">
                            <ul class="goal-info-nav nav  nav-justified">
                                <li role="presentation" class="active" data-content="tab1">
                                    <a href="#">
                            ...
                            <div data-content="tab1" class="tab-content active ">
                                <ul>
                                ...
                                <asp:Repeater ID="rptGoals" runat="server">
                                    <ItemTemplate>
                                        <li class=" <%#Eval("id").ToParseStr()==Page.RouteData.Values["goalId"].ToParseStr()?"active":"" %>">
                                            <a href="<%#string.Format("/{0}/national-priority/{1}/{2}",Config.getLang(Page),Eval("id"),Config.Slug(Eval("name_short_"+Config.getLang(Page)).ToParseStr()))%>">
