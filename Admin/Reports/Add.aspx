<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="Admin_Reports_Add" %>
        ...
        <div class="portlet-body form">
            ...
            <div class="form-horizontal">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">
                            <asp:Literal ID="Literal5" runat="server" Text="Qısa mətn  (AZ)"></asp:Literal>
                        </label>
                        <div class="col-md-4">
                            <dx:ASPxHtmlEditor ID="content_short_az" runat="server" SettingsImageUpload-UploadImageFolder="~/uploads/pages">
                                <Toolbars>
                                    <dx:HtmlEditorToolbar Name="StandardToolbar1">
                                        <Items>
                                            <dx:ToolbarCutButton>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">
                            <asp:Literal ID="Literal6" runat="server" Text="Qısa mətn  (EN)"></asp:Literal>
                        </label>
                        <div class="col-md-4">
                            <dx:ASPxHtmlEditor ID="content_short_en" runat="server" SettingsImageUpload-UploadImageFolder="~/uploads/pages">
                                <Toolbars>
                                    <dx:HtmlEditorToolbar Name="StandardToolbar1">
                                        <Items>
                                            <dx:ToolbarCutButton>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <asp:FileUpload runat="server" ID="fuImage_az" />
                        </div>
                    </div>
                     <div class="form-group">
                        <label class="col-md-3 control-label">
                            <asp:Literal ID="Literal1" runat="server" Text="Şəkil en"></asp:Literal>
                        </label>
                        <div class="col-md-4">
                            <asp:FileUpload runat="server" ID="fuImage_en" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">
