<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="Admin_Partners_Add" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label class="col-md-3 control-label">
                            <asp:Literal ID="Literal1" runat="server" Text="Keçid "></asp:Literal>
                        </label>
                        <div class="col-md-4">
                            <asp:TextBox ID="Url" runat="server" CssClass="form-control " data-type="note" TextMode="Url"  MaxLength="1000"></asp:TextBox>
                        </div>
                    </div>
