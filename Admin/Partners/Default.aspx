<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Admin_Partners_Default" %>
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataMemoColumn Caption="Başlıq (AZ)" FieldName="title_az" VisibleIndex="3"></dx:GridViewDataMemoColumn>
                             <dx:GridViewDataMemoColumn Caption="Başlıq (EN)" FieldName="title_en" VisibleIndex="3"></dx:GridViewDataMemoColumn>

                            <dx:GridViewDataColumn Caption="" Width="80" VisibleIndex="7">
                                <DataItemTemplate>
