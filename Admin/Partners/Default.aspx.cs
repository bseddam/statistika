...
public partial class Admin_Partners_Default : System.Web.UI.Page
{
    ...
    protected void LnkPnlMenu_Click(object sender, EventArgs e)
    {
        ...
        {
            case "add":
                Config.Rd("/admin/partners/add.aspx");
                break;
            //case "search":
    ...
    {
        _db.PartnerDelete((sender as LinkButton).CommandArgument.ToParseInt());
