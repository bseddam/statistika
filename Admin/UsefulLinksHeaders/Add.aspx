            ...
            <div class="form-horizontal">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <dx:ASPxHtmlEditor ID="useful_links_headers_az" runat="server" SettingsImageUpload-UploadImageFolder="~/uploads/pages">
                            </dx:ASPxHtmlEditor>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <dx:ASPxHtmlEditor ID="useful_links_headers_en" runat="server" SettingsImageUpload-UploadImageFolder="~/uploads/pages">
                            </dx:ASPxHtmlEditor>
                        </div>
                    </div>
