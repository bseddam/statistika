<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Admin_Publications_Default" %>
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn Caption="No" FieldName="id" VisibleIndex="1" Width="50"></dx:GridViewDataColumn>
                            <dx:GridViewDataComboBoxColumn Caption="Kateqoriya" FieldName="category_id" VisibleIndex="2" Width="200">
                                <EditFormSettings VisibleIndex="0" Visible="true" ColumnSpan="2" />
                            </dx:GridViewDataComboBoxColumn>

                            <dx:GridViewDataColumn Caption="Başlıq (AZ)" FieldName="title_az" VisibleIndex="2">
                                <DataItemTemplate>
                                    <%#Config.HtmlRemoval.StripTagsRegex(Eval("title_az").ToParseStr()) %>
                                </DataItemTemplate>
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataMemoColumn Caption="Başlıq (EN)" FieldName="title_en" VisibleIndex="3">
                                <DataItemTemplate>
