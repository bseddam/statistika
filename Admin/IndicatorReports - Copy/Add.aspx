<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="Admin_IndicatorReports_Add" %>
        ...
        <ContentTemplate>
            ...
            <div class="portlet box blue-madison">
                ...
                <div class="portlet-body ">
                    ...
                    <br />
                    <span class="muted">- Cari ilə düzəliş etmək üçün üzərinə klik edin</span>
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"  
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn Caption="Region" Width="200"  FieldName="region_name" VisibleIndex="2" FixedStyle="Left">
                                <EditFormSettings Visible="False" />
                            </dx:GridViewDataColumn>
                        </Columns>
                        <Settings HorizontalScrollBarMode="Visible" VerticalScrollableHeight="400" 
                            VerticalScrollBarMode="Visible" ShowFilterRow="false" GridLines="Both" />
                        <SettingsPager Mode="ShowAllRecords">
                        </SettingsPager>
                        <SettingsText CommandNew="Yeni" CommandBatchEditCancel="Ləğv et" CommandBatchEditUpdate="Yadda saxla" CommandDelete="Sil" CommandCancel="Ləğv et" CommandEdit="Yenilə" CommandUpdate="Yadda saxla" CustomizationWindowCaption="Sütun seçin" ConfirmDelete="Silmək istəditinizə əminsiniz?" />
