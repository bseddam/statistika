<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Admin_IndicatorReports_Default" %>
                ...
                <asp:Panel runat="server" CssClass="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataComboBoxColumn Caption="Göstəricinin tipi" FieldName="type_id" VisibleIndex="2">
                                <EditFormSettings ColumnSpan="2" />
                            </dx:GridViewDataComboBoxColumn>
                            <dx:GridViewDataColumn Caption="Göstəricinin kodu" FieldName="code" VisibleIndex="3" Width="100">
                                <EditFormSettings ColumnSpan="2" />
                                <DataItemTemplate>
                                    <%#Config.ClearIndicatorCode( Eval("code").ToParseStr()) %>
                                </DataItemTemplate>
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn Caption="Göstəricinin adı" FieldName="name_az" VisibleIndex="3">
                                <EditFormSettings ColumnSpan="2" Visible="True" />
                            </dx:GridViewDataColumn>

                            <dx:GridViewDataColumn Caption="#" FieldName="" VisibleIndex="4">
                                <DataItemTemplate>
                                    <a href="add.aspx?id=<%#Eval("id") %>">Məlumat daxil et</a>
                                </DataItemTemplate>
                            </dx:GridViewDataColumn>
