...
public partial class Admin_List_IndicatorSize : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ltrPageTitle.Text = "Ölçü vahidləri";
    ...
    void _loadGridFromDb()
    {
        ...
        DataTable dt = _db.GetIndicatorSize();
    ...
    {
        Utils.MethodType val = _db.IndicatorSizeUpdate(
    ...
    {
        Utils.MethodType val = _db.IndicatorSizeDelete(
                             id: e.Keys["id"].ToParseInt()
                         );
        Grid.StartEdit(-1);
        _loadGridFromDb();
    ...
    {
        Utils.MethodType val = _db.IndicatorSizeInsert(
                             name_az: e.NewValues["name_az"].ToParseStr(),
                             name_en: e.NewValues["name_en"].ToParseStr(),
                             code: e.NewValues["code"].ToParseStr()
                         );
    ...
    {
       // Grid.SettingsCookies.Version = "7.0";
