<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="IndicatorSize.aspx.cs" Inherits="Admin_List_IndicatorSize" %>
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                       ...
                       SettingsBehavior-ConfirmDelete="true"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn Caption="Kod" FieldName="code" VisibleIndex="2" Width="200">
                                <EditFormSettings VisibleIndex="0" Visible="true" ColumnSpan="2" />
                            </dx:GridViewDataColumn>

                            <dx:GridViewDataMemoColumn Caption="Ölçü vahidinin adı  (AZ)" FieldName="name_az" VisibleIndex="3">
                                <EditFormSettings VisibleIndex="0" />
                            </dx:GridViewDataMemoColumn>

                            <dx:GridViewDataMemoColumn Caption="Ölçü vahidinin adı  (EN)" FieldName="name_en" VisibleIndex="4">
                        ...
                        <SettingsText CommandNew="Yeni" CommandDelete="Sil" CommandCancel="Ləğv et"
                             CommandEdit="Yenilə" CommandUpdate="Yadda saxla" CustomizationWindowCaption="Sütun seçin" ConfirmDelete="Silmək istədiyinizə əminsiniz?" />
