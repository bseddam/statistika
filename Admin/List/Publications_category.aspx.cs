...
public partial class Admin_List_Publications_category : System.Web.UI.Page
{
    DALC _db = new DALC();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ltrPageTitle.Text = "Nəşrlər kateroqiya";
    ...
    void _loadGridFromDb()
    {
        ...
        DataTable dt = _db.GetPublicationCategory();
    ...
    {
        Utils.MethodType val = _db.PublicationCategoryUpdate(
    ...
    {
        Utils.MethodType val = _db.PublicationCategoryDelete(
                             id: e.Keys["id"].ToParseInt()
                         );
        Grid.StartEdit(-1);
        _loadGridFromDb();
    ...
    {
        Utils.MethodType val = _db.PublicationCategoryInsert(
                             orderBy: e.NewValues["orderBy"].ToParseInt(),
                             name_az: e.NewValues["name_az"].ToParseStr(),
                             name_en: e.NewValues["name_en"].ToParseStr()
                         );
