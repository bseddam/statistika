...
public partial class Admin_List_MetadataList_Global : System.Web.UI.Page
{
    DALC _db = new DALC();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ltrPageTitle.Text = "Qlobal metaməlumatların strukturu";
    ...
    {
        Utils.MethodType val = _db.MetaDataListUpdate_global(
    ...
    {
        Utils.MethodType val = _db.MetaDataListDelete_global(id: e.Keys["id"].ToParseInt());
    ...
    {
        Utils.MethodType val = _db.MetaDataListInsert_global(
                                  code: (e.NewValues["code"]).ToParseStr(),
                                  name_az: (e.NewValues["name_az"]).ToParseStr(),
                                  name_en: (e.NewValues["name_en"]).ToParseStr()
                              );
