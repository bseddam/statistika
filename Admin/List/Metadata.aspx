<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Metadata.aspx.cs" Inherits="Admin_List_Metadata" %>
        ...
        <ContentTemplate>
                ...
                <div class="portlet-body ">
                    <div class="col-md-4 margin-bottom-5">
                        ...
                        <dx:ASPxComboBox ID="GoalList" ClientInstanceName="GoalList"
                            ...
                            AutoPostBack="true" OnSelectedIndexChanged="GoalList_SelectedIndexChanged"
                            IncrementalFilteringMode="Contains"
                            LoadingPanelText="Yüklənir&amp;hellip;"
            ...
            <asp:Panel runat="server" ID="PnlContent" CssClass="portlet box blue-madison">
                ...
                <asp:Panel runat="server" CssClass="portlet-body ">
                    <dx:ASPxTreeListExporter ID="gridExporter" runat="server" Settings-PageSettings-PaperKind="A4" Settings-PageSettings-Landscape="True"></dx:ASPxTreeListExporter>
                    <dx:ASPxTreeList ID="Grid" runat="server"
                        OnNodeUpdating="Grid_NodeUpdating"
                        OnNodeDeleting="Grid_NodeDeleting"
                        OnNodeInserting="Grid_NodeInserting"
                        AutoGenerateColumns="False"
                        Width="100%"
                        SettingsBehavior-ConfirmDelete="true"
                        KeyFieldName="list_id"
                        ParentFieldName="sub_id">
                        <Settings GridLines="Both" />
                        <SettingsPopupEditForm AllowResize="True"
                            Modal="true" HorizontalAlign="Center"
                            VerticalAlign="Above" Height="400px"></SettingsPopupEditForm>
                        <SettingsEditing Mode="EditFormAndDisplayNode"></SettingsEditing>
                        <Columns>
                            <dx:TreeListTextColumn Caption="Maddə" FieldName="no" VisibleIndex="1" Width="30">
                                <EditFormSettings Visible="False" />
                            </dx:TreeListTextColumn>
                          
                            <dx:TreeListTextColumn Caption="Anlayışın adı (AZ)" FieldName="ml_name_az" ReadOnly="true" VisibleIndex="2" Width="100">
                                <EditFormSettings ColumnSpan="2" />
                            </dx:TreeListTextColumn>
                            <dx:TreeListTextColumn Caption="Anlayışın adı (EN)" FieldName="ml_name_en" ReadOnly="true" VisibleIndex="2" Width="100">
                                <EditFormSettings ColumnSpan="2" />
                            </dx:TreeListTextColumn>
                            <dx:TreeListComboBoxColumn Caption="Anlayışın kodu" FieldName="code" ReadOnly="true" VisibleIndex="2" Width="100">
                                <EditFormSettings ColumnSpan="2" />
                            </dx:TreeListComboBoxColumn>
                            <dx:TreeListTextColumn Caption="Anlayışın təsviri (AZ)" PropertiesTextEdit-EncodeHtml="false" FieldName="name_az" VisibleIndex="3">
                                <EditFormSettings ColumnSpan="2" Visible="False" />
                            </dx:TreeListTextColumn>
                            <dx:TreeListTextColumn Caption="Anlayışın təsviri (EN)" PropertiesTextEdit-EncodeHtml="false" FieldName="name_en" VisibleIndex="4">
                                <EditFormSettings ColumnSpan="2" Visible="False" />
                            </dx:TreeListTextColumn>
                            <dx:TreeListCommandColumn Caption="#" Width="70" VisibleIndex="7">
                        ...
                        <SettingsText CommandNew="Yeni"
                            CommandDelete="Sil"
                            CommandCancel="Ləğv et"
                            CommandEdit="Yenilə"
                            CommandUpdate="Yadda saxla"
                            CustomizationWindowCaption="Sütun seçin"
                            ConfirmDelete="Silmək istəditinizə əminsiniz?" />
                                        ...
                                        <dx:TabPage Text="Ümumi məlumat">
                                            <ContentCollection>
                                                <dx:ContentControl runat="server">
                                                    <dx:ASPxTreeListTemplateReplacement runat="server"
