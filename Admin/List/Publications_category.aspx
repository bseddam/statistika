<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Publications_category.aspx.cs" Inherits="Admin_List_Publications_category" %>
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataMemoColumn Caption="Başlıq  (AZ)" FieldName="name_az" VisibleIndex="3">
                                <EditFormSettings VisibleIndex="1" />
                            </dx:GridViewDataMemoColumn>

                            <dx:GridViewDataMemoColumn Caption="Başlıq  (EN)" FieldName="name_en" VisibleIndex="4">
                                <EditFormSettings VisibleIndex="2" />
                            </dx:GridViewDataMemoColumn>

                            <dx:GridViewDataSpinEditColumn Caption="Sıralama" FieldName="orderBy" VisibleIndex="4">
                                <EditFormSettings VisibleIndex="03" ColumnSpan="2" />
