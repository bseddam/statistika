...
public partial class Admin_List_Qurum : System.Web.UI.Page
{
    DALC _db = new DALC();
    ...
    {
        Utils.MethodType val = _db.QurumUpdate(
    ...
    {
        Utils.MethodType val = _db.QurumDelete(
                             id: e.Keys["id"].ToParseInt()
                         );
        Grid.StartEdit(-1);
        _loadGridFromDb();
    ...
    {
        Utils.MethodType val = _db.QurumInsert(
                             name_az: e.NewValues["name_az"].ToParseStr(),
                             name_en: e.NewValues["name_en"].ToParseStr(),
                             code: e.NewValues["code"].ToParseStr()
                         );
