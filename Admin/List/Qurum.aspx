<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Qurum.aspx.cs" Inherits="Admin_List_Qurum" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="icons-panel tools">
                                    <ul>
                                        <li>
                                            <asp:LinkButton ID="btnAdd" runat="server" CssClass="btn_add"
                                                 CommandArgument="add" ><i class="fa fa-plus"></i> Yeni</asp:LinkButton>
                                        </li>
                                        <li>
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataMemoColumn Caption="Qurumun adı (AZ)" FieldName="name_az" VisibleIndex="3">
                                <EditFormSettings VisibleIndex="0" />
                            </dx:GridViewDataMemoColumn>

                            <dx:GridViewDataMemoColumn Caption="Qurumun adı (EN)" FieldName="name_en" VisibleIndex="4">
                                <EditFormSettings VisibleIndex="2" />
                            </dx:GridViewDataMemoColumn>

                            <dx:GridViewCommandColumn ShowEditButton="True" ShowNewButtonInHeader="true" ShowDeleteButton="true" VisibleIndex="5" HeaderStyle-CssClass="treelist-new-column">
