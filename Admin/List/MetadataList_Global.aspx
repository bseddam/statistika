<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="MetadataList_Global.aspx.cs" Inherits="Admin_List_MetadataList_Global" %>
            ...
            <div class="portlet box blue-madison">
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxTreeList ID="treeList" runat="server"
                        ...
                        KeyFieldName="id" ParentFieldName="sub_id">
                        ...
                        <Columns>
                            ...
                            <dx:TreeListTextColumn Caption="Anlayışın adı (AZ)" FieldName="name_az">
                                <EditFormSettings VisibleIndex="1"  ColumnSpan="2"/>
                            </dx:TreeListTextColumn>
                            <dx:TreeListTextColumn Caption="Anlayışın adı (EN)" FieldName="name_en">
                                <EditFormSettings VisibleIndex="2"  ColumnSpan="2"/>
                            </dx:TreeListTextColumn>
                            <dx:TreeListCommandColumn ShowNewButtonInHeader="true" Width="200" HeaderStyle-CssClass="treelist-new-column">
