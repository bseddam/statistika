<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Regions.aspx.cs" Inherits="Admin_List_Regions" %>
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataComboBoxColumn Caption="Parent" FieldName="sub_id" VisibleIndex="2" Width="200">
                            ...
                            <dx:GridViewDataMemoColumn Caption="Mətn  (AZ)" FieldName="name_az" VisibleIndex="3">
                                <EditFormSettings VisibleIndex="0" />
                            </dx:GridViewDataMemoColumn>

                            <dx:GridViewDataMemoColumn Caption="Mətn  (EN)" FieldName="name_en" VisibleIndex="4">
