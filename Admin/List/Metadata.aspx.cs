...
public partial class Admin_List_Metadata : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ltrPageTitle.Text = "Milli metaməlumatlar";
    ...
    void _loadGridFromDb()
    {
        ...
        _db.MetadataUpdateAll(Indicator.Value.ToParseInt());


        //#region
        //DataTable dt = _db.GetMetaDataList();

        //TreeListComboBoxColumn column = Grid.Columns["list_id"] as TreeListComboBoxColumn;
        ...
        DataTable dt = _db.GetMetaData(Indicator.Value.ToParseInt());
    ...
    protected void Grid_NodeUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
    {
        ...
        Utils.MethodType val = _db.MetaDataUpdate(
                                        indicator_id: Indicator.Value.ToParseInt(),
                                        list_id: e.Keys["list_id"].ToParseInt(),
    ...
    protected void Grid_NodeDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
    {
        Utils.MethodType val = _db.MetaDataDelete(id: e.Keys["id"].ToParseInt());
        Grid.StartEdit("-1");
        _loadGridFromDb();
        e.Cancel = true;
    }
    protected void Grid_NodeInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        //ASPxPageControl tabs = Grid.FindEditFormTemplateControl("tabs") as ASPxPageControl;
        ...
        //Utils.MethodType val = _db.MetaDataInsert(
        //                        indicator_id: Indicator.Value.ToParseInt(),
        //                        list_id: e.Keys["list_id"].ToParseInt(),
        //                        name_az: txtDesc_az.Html,
        //                        name_en: txtDesc_en.Html
    ...
    {
        DataTable dtGoals = _db.GetIndicators(GoalList.Value.ToParseInt(), 0);
