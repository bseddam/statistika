...
public partial class Admin_List_Regions : System.Web.UI.Page
{
    DALC _db = new DALC();
    ...
    void _loadGridFromDb()
    {
        ...
        DataTable dt = _db.GetRegion();


        GridViewDataComboBoxColumn column = Grid.Columns["sub_id"] as GridViewDataComboBoxColumn;
        ...
        column.PropertiesComboBox.Items.Insert(0, new DevExpress.Web.ASPxEditors.ListEditItem(_defaultDropdownRowText1, "0"));
    ...
    {
        Utils.MethodType val = _db.RegionUpdate(
    ...
    {
        Utils.MethodType val = _db.RegionDelete(
                             id: e.Keys["id"].ToParseInt()
                         );
        Grid.StartEdit(-1);
        _loadGridFromDb();
    ...
    {
        Utils.MethodType val = _db.RegionInsert(
                             sub_id: e.NewValues["sub_id"].ToParseInt(),
                             name_az: e.NewValues["name_az"].ToParseStr(),
                             name_en: e.NewValues["name_en"].ToParseStr(),
                             code: e.NewValues["code"].ToParseStr()
