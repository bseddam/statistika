<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="MetadataList.aspx.cs" Inherits="Admin_List_MedataList" %>
            ...
            <div class="portlet box blue-madison">
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxTreeList ID="treeList" runat="server"
                        ...
                        <Columns>
                            <dx:TreeListTextColumn Caption="Maddə" FieldName="no" Width="20">
                                <EditFormSettings VisibleIndex="0" />
                            </dx:TreeListTextColumn>
                            <dx:TreeListTextColumn Caption="Anlayışın kodu" FieldName="code" Width="100">
                                <EditFormSettings VisibleIndex="2" />
                            </dx:TreeListTextColumn>
                            <dx:TreeListComboBoxColumn Caption="Parent" FieldName="sub_id" Visible="false">
                                <EditFormSettings VisibleIndex="0" ColumnSpan="2" Visible="True" />
                            </dx:TreeListComboBoxColumn>
                            <dx:TreeListTextColumn Caption="Anlayışın adı (AZ)" FieldName="name_az" Width="100">
                                <EditFormSettings VisibleIndex="1" />
                            </dx:TreeListTextColumn>
                            <dx:TreeListTextColumn Caption="Anlayışın adı (EN)" FieldName="name_en" Width="100">
                                <EditFormSettings VisibleIndex="1" />
                            </dx:TreeListTextColumn>
                            
                            <dx:TreeListMemoColumn Caption="Anlayışın izahı" CellStyle-Wrap="True" FieldName="description">
                                <EditFormSettings VisibleIndex="2" />
                            </dx:TreeListMemoColumn>
                            <dx:TreeListCommandColumn ShowNewButtonInHeader="true" Width="100" HeaderStyle-CssClass="treelist-new-column">
