<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Admin_Values_Default" %>
            ...
            <asp:Panel ID="PnlSearch" runat="server" CssClass="portlet box green filter-panel">
                ...
                <div class="portlet-body ">
                    <div class="col-md-4 margin-bottom-5">
                        <label></label>
                        <dx:ASPxComboBox ID="Pages" ClientInstanceName="Id"
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <SettingsPopup EditForm-Width="600"  EditForm-Modal="True" EditForm-VerticalAlign="Middle"
                             EditForm-HorizontalAlign="Center" EditForm-AllowResize="True" />
                        <Columns>
                            ...
                            <dx:GridViewDataColumn Caption="Açar söz" FieldName="key" VisibleIndex="2" >
                                <EditFormSettings VisibleIndex="0" Visible="false" />
                            </dx:GridViewDataColumn>

                            <dx:GridViewDataMemoColumn Caption="Mətn  (AZ)" FieldName="name_az" VisibleIndex="3" Width="40%">
                                <EditFormSettings VisibleIndex="0" ColumnSpan="2" RowSpan="4" Visible="false" />
                            </dx:GridViewDataMemoColumn>

                            <dx:GridViewDataMemoColumn Caption="Mətn  (EN)" FieldName="name_en" VisibleIndex="4" Width="40%">
                                <EditFormSettings VisibleIndex="2" ColumnSpan="2" RowSpan="4" Visible="false" />
                            </dx:GridViewDataMemoColumn>

                            <dx:GridViewCommandColumn ShowEditButton="True" VisibleIndex="5">
