<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Admin_SiteMap_Default" %>
            ...
            <div class="portlet box blue-madison">
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxTreeList ID="treeList" runat="server"
                        ...
                        <SettingsEditing Mode="EditFormAndDisplayNode" AllowNodeDragDrop="true" ConfirmDelete="true" />
                        ...
                        <Columns>
                            ...
                            <dx:TreeListComboBoxColumn Caption="ParentId" FieldName="ParentId" Visible="false">
                                <EditFormSettings VisibleIndex="0" Visible="True" ColumnSpan="3" />
