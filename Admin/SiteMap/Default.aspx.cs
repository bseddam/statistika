...
public partial class Admin_SiteMap_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ltrPageTitle.Text = "Saytın xəritəsi";
    ...
    {
        if (e.NewValues["Name_az"] == null)
        {
            Utils.MethodType val = _db.SiteMapUpdate(
    ...
    {
        Utils.MethodType val = _db.SitemapDelete(id: e.Keys["Id"].ToParseInt());
    ...
    {
        Utils.MethodType val = _db.SitemapInsert(
                                  URL: e.NewValues["URL"].ToParseStr(),
                                  parentid: e.NewValues["ParentId"].ToParseInt(),
                                  Name_az: e.NewValues["Name_az"].ToParseStr(),
                                  Name_en: e.NewValues["Name_en"].ToParseStr(),
