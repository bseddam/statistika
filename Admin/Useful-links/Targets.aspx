<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Targets.aspx.cs" Inherits="Admin_Useful_links_Default" %>
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataComboBoxColumn Caption="Məqsəd" FieldName="goal_id" EditFormSettings-RowSpan="4"
                                EditFormSettings-ColumnSpan="2" VisibleIndex="1" Width="200">
                            </dx:GridViewDataComboBoxColumn>

                            <dx:GridViewDataMemoColumn Caption="Ad  (AZ)" FieldName="name_az" VisibleIndex="3">
                                <EditFormSettings VisibleIndex="0" ColumnSpan="2" RowSpan="4" />
                            </dx:GridViewDataMemoColumn>

                            <dx:GridViewDataMemoColumn Caption="Ad  (EN)" FieldName="name_en" VisibleIndex="4">
                                <EditFormSettings VisibleIndex="0" ColumnSpan="2" RowSpan="4" />
                            </dx:GridViewDataMemoColumn>
                            <dx:GridViewDataMemoColumn Caption="Link" FieldName="link" VisibleIndex="5">
                                <EditFormSettings VisibleIndex="0" ColumnSpan="2" RowSpan="4" />
                            </dx:GridViewDataMemoColumn>
