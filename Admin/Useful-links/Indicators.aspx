<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Indicators.aspx.cs" Inherits="Admin_Useful_links_Indicators" %>
            ...
            <asp:Panel ID="PnlSearch" runat="server" CssClass="portlet box green filter-panel">
                ...
                <div class="portlet-body ">
                    <div class="col-md-4 margin-bottom-5">
                        <dx:ASPxComboBox ID="Goals" ClientInstanceName="Goals"
                            ...
                            OnSelectedIndexChanged="Goals_SelectedIndexChanged"
                            Width="100%" Height="30px">
                        </dx:ASPxComboBox>
                    </div>
                    <div class="col-md-4 margin-bottom-5">
                        <asp:RadioButtonList ID="rdNational" runat="server" AutoPostBack="true" RepeatDirection="Horizontal" OnSelectedIndexChanged="rdNational_SelectedIndexChanged">
                            <asp:ListItem Value="0" Text="Qlobal göstəricilər" />
                            <asp:ListItem Value="1" Selected="True" Text="Milli göstəricilər" />
                        </asp:RadioButtonList>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="icons-panel tools">
                                    <ul>
                                        <li>
                                            <asp:LinkButton ID="btnAdd" runat="server" CssClass="btn_add" CommandArgument="add"><i class="fa fa-plus"></i> Yeni</asp:LinkButton>
                                        </li>
                                        <li>
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn Caption="No" FieldName="id" VisibleIndex="0" Width="50">
                                <EditFormSettings VisibleIndex="0" Visible="false" />
                            </dx:GridViewDataColumn>

                            <dx:GridViewDataComboBoxColumn Caption="Göstərici" FieldName="indicator_id" VisibleIndex="0" Width="200" >
                                <EditFormSettings VisibleIndex="5" />
                            </dx:GridViewDataComboBoxColumn>
                            <dx:GridViewDataColumn Caption="Qurum  (AZ)" FieldName="qurum_name_az" VisibleIndex="3">
                                <EditFormSettings VisibleIndex="1" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn Caption="Qurum  (EN)" FieldName="qurum_name_en" Visible="false" VisibleIndex="3">
                                <EditFormSettings VisibleIndex="2" Visible="True"  />
                            </dx:GridViewDataColumn>

                            <dx:GridViewDataColumn Caption="Partnyor  (AZ)" FieldName="partner_name_az" VisibleIndex="4">
                                <EditFormSettings VisibleIndex="3"  />
                            </dx:GridViewDataColumn>

                            <dx:GridViewDataColumn Caption="Partnyor  (EN)" FieldName="partner_name_en" Visible="false"  VisibleIndex="4">
                                <EditFormSettings VisibleIndex="4" Visible="True"  />
                            </dx:GridViewDataColumn>

                            <dx:GridViewDataColumn Caption="Partnyor link" FieldName="partner_link" Visible="false"  VisibleIndex="5">
                                <EditFormSettings VisibleIndex="6" Visible="True" />
                            </dx:GridViewDataColumn>


                            <dx:GridViewCommandColumn ShowEditButton="True" ShowDeleteButton="true" ShowNewButtonInHeader="true" HeaderStyle-CssClass="treelist-new-column" VisibleIndex="5">
