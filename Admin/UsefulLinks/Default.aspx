<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Admin_Slider_Default" %>
            ...
            <div class="portlet box blue-madison">
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            <dx:GridViewDataColumn Caption="No" FieldName="id1" VisibleIndex="1" Width="50"></dx:GridViewDataColumn>
                            <dx:GridViewDataComboBoxColumn Caption="Link başlığı (AZ)" FieldName="useful_links_header_id" VisibleIndex="2" Width="200"></dx:GridViewDataComboBoxColumn>
                           
                            <dx:GridViewDataComboBoxColumn Caption="Link başlığı (EN)" FieldName="useful_links_header_id1" VisibleIndex="2" Width="200"></dx:GridViewDataComboBoxColumn>
                           
                            <dx:GridViewDataMemoColumn Caption="Link adı (AZ)" FieldName="useful_links_name_az" VisibleIndex="3"></dx:GridViewDataMemoColumn>
                            <dx:GridViewDataMemoColumn Caption="Link adı (EN)" FieldName="useful_links_name_en" VisibleIndex="3"></dx:GridViewDataMemoColumn>
                            <dx:GridViewDataColumn Caption="" Width="70" VisibleIndex="7">
                                <DataItemTemplate>
                                    <asp:LinkButton Text="Yenilə" runat="server" OnClick="Edit_Click" CommandArgument='<%#Eval("id1") %>' />
                                    <asp:LinkButton Text="Sil" runat="server" OnClientClick="return confirm('Silmək istəditinizə əminsiniz?');" ID="delete" OnClick="delete_Click" CommandArgument='<%#Eval("id1") %>' />
                                </DataItemTemplate>
