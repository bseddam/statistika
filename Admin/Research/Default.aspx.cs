...
public partial class Admin_Research_Default : System.Web.UI.Page
{
    DALC _db = new DALC();
    ...
    {
        DataTable dt = _db.GetResearches();
    ...
    protected void LnkPnlMenu_Click(object sender, EventArgs e)
    {
        ...
        {
            case "add":
                Config.Rd("/admin/research/add.aspx");
                break;
            //case "search":
    ...
    {
        _db.ResearchDelete((sender as LinkButton).CommandArgument.ToParseInt());
        _loadGridFromDb();
    }
}