...
public partial class Admin_Pages_Links : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ltrPageTitle.Text = "Beynəlxalq çağırışlar>Keçidlər";
    ...
    protected void Grid_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
    {
        Utils.MethodType val = _db.PageUpdate(
                             ...
                             typeid: (int)Utils.PageType.InternationalLinks,
                             title_az: e.NewValues["title_az"].ToParseStr(),
                             title_en: e.NewValues["title_en"].ToParseStr(),
                             more_url: e.NewValues["more_url"].ToParseStr(),
    ...
    {
        Utils.MethodType val = _db.PageInsert((int)Utils.PageType.InternationalLinks,
               e.NewValues["title_az"].ToParseStr(),
                "", e.NewValues["title_en"].ToParseStr(),
                "", "", "",
                 DateTime.Now,
                "", 0, 0, "", e.NewValues["orderBy"].ToParseInt());
