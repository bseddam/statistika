<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" Inherits="Admin_Pages_Add" %>
    ...
    <div class="portlet box green-haze">
        ...
        <div class="portlet-body form">
            ...
            <div class="form-horizontal">
                ...
                <div class="form-body">
                    <asp:Panel runat="server" ID="pnlLaw">
                    ...
                    <asp:Panel runat="server" ID="pnlCategory">
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                                <asp:Literal ID="Literal5" runat="server" Text="Kategoriya"></asp:Literal>
                            </label>
                            <div class="col-md-4">
                                <dx:ASPxComboBox ID="PageId" ClientInstanceName="PageId"
                                    runat="server" NullText="Siyahıdan seçin"
                                    AnimationType="Slide" EnableTheming="True"
                                    IncrementalFilteringMode="Contains" LoadingPanelText="Yüklənir&amp;hellip;"
                                    TextField="title_az" ValueField="id"
                                    Width="100%" Height="30px">
                                </dx:ASPxComboBox>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">
                            <asp:Literal ID="Literal10" runat="server" Text="Məzmun (AZ)"></asp:Literal>
                        </label>
                        <div class="col-md-7">

                            <asp:TextBox runat="server" Width="100%" CssClass="form-control" ID="title_az" TextMode="MultiLine" Height="200"  />

                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">
                            <asp:Literal ID="Literal11" runat="server" Text="Məzmun  (EN)"></asp:Literal>
                        </label>
                        <div class="col-md-7">
                            <asp:TextBox runat="server" Width="100%" ID="title_en" TextMode="MultiLine" Height="200" />
                        </div>
                    </div>
                    <asp:Panel runat="server" ID="pnlVideo">
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                                <asp:Literal ID="Literal1" runat="server" Text="Youtube video URL"></asp:Literal>
                            </label>
                            <div class="col-md-4">
                                <asp:TextBox ID="txtVideoURL" runat="server" CssClass="form-control " data-type="note" TextMode="SingleLine" MaxLength="1000"></asp:TextBox>
                            <br />
                                Numune: https://www.youtube.com/watch?v=7XstMOwE3xk
                            </div>
                        </div>
                    </asp:Panel>
                    <asp:Panel runat="server" ID="pnlMoreUrl">
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                                <asp:Literal ID="Literal4" runat="server" Text="Keçid linki"></asp:Literal>
                            </label>
                            <div class="col-md-4">
                                <asp:TextBox ID="txtMoreUrl" runat="server" CssClass="form-control " data-type="note" TextMode="SingleLine" MaxLength="1000"></asp:TextBox>
                            </div>
                        </div>
                    </asp:Panel>
                    <div class="form-group">
                    ...
                    <asp:Panel ID="PnlOrderBy" runat="server">
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <span class="form-text text-muted">
                                    <asp:Literal ID="lblImageHelper" Text="- Bir neçə şəkil yükləmək üçün CTRL sıxıb şəkilləri seçin" runat="server" /></span>
                            </div>
                        </div>
                    </asp:Panel>
