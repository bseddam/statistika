...
public partial class Admin_Pages_Terefler : System.Web.UI.Page
{
    DALC _db = new DALC();
    ...
    {
        GoalList.DataSource = _db.GetPages(Utils.PageType.TerefdaslarCategory);
        GoalList.DataBind();
    }
    ...
    Utils.PageType getPageType
    {
        ...
        get
        {
            Utils.PageType _type = Utils.PageType.Terefdaslar;
    ...
    {
        DataTable dt = _db.GetPagesByPageID(getPageType, GoalList.Value.ToParseInt());
    ...
    protected void LnkPnlMenu_Click(object sender, EventArgs e)
    {
        ...
        switch (btn.CommandArgument)
        {
            ...
            case "add":
                Config.Rd("/admin/pages/" + pageNAme + ".aspx?typeid=sides");
                break;
            //case "search":
            //    PnlSearch.Visible = true;
            //    break;
    ...
    protected void Edit_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect(pageNAme + ".aspx?id=" + (sender as LinkButton).CommandArgument + "&typeid=sides", true);
    }
