<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Admin_Pages_Default" %>
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn Caption="ID" FieldName="id" VisibleIndex="1" Width="50"></dx:GridViewDataColumn>
                            <dx:GridViewDataColumn Caption="No" FieldName="orderBy" VisibleIndex="1" Width="50"></dx:GridViewDataColumn>

                            <dx:GridViewDataColumn Caption="Məzmun (AZ)" FieldName="title_az" VisibleIndex="2">
                                <DataItemTemplate>
                                    <%#Config.HtmlRemoval.StripTagsRegexCompiled(Eval("title_az").ToParseStr()) %>
                                </DataItemTemplate>
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataMemoColumn Caption="Məzmun (EN)" FieldName="title_en" VisibleIndex="3">
                                <DataItemTemplate>
                                    <%#Config.HtmlRemoval.StripTagsRegex(Eval("title_en").ToParseStr()) %>
                                </DataItemTemplate>
                            </dx:GridViewDataMemoColumn>
                            <dx:GridViewDataMemoColumn Caption="Tarix" FieldName="pageDt" VisibleIndex="3" Width="100"></dx:GridViewDataMemoColumn>
                            <dx:GridViewDataColumn VisibleIndex="5" Caption="URL" Width="150">
                                <DataItemTemplate>
                                    <input type="text" readonly="readonly" name="name" onclick="this.select()" class="form-control" value="<%#getPageURL(Eval("type_id").ToParseInt(),Eval("id").ToParseInt()) %>" style="background-color: #eaeaea" />
                                </DataItemTemplate>
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn Caption="#" Width="70" VisibleIndex="7">
                                <DataItemTemplate>
                                    <asp:LinkButton Text="Yenilə" runat="server" OnClick="Edit_Click" CommandArgument='<%#Eval("id") %>' />
                                    <asp:LinkButton Text="Sil" runat="server" ID="delete" OnClientClick="return confirm('Silmək istəditinizə əminsiniz?');" OnClick="delete_Click" CommandArgument='<%#Eval("id") %>' />
