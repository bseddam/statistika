<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Links.aspx.cs" Inherits="Admin_Pages_Links" %>
            ...
            <div class="portlet box blue-madison">
                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        OnRowInserting="Grid_RowInserting" SettingsBehavior-ConfirmDelete="true"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn Caption="No" FieldName="orderBy" VisibleIndex="1" Width="50">
                                <EditFormSettings VisibleIndex="0" Visible="true" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataMemoColumn Caption="Məzmun  (AZ)" FieldName="title_az" VisibleIndex="3">
                            ...
                            <dx:GridViewDataMemoColumn Caption="Məzmun  (EN)" FieldName="title_en" VisibleIndex="4">
                            ...
                            <dx:GridViewDataHyperLinkColumn Caption="Keçid linki" FieldName="more_url" VisibleIndex="4">
                                <EditFormSettings VisibleIndex="2" />
                            </dx:GridViewDataHyperLinkColumn>
                            <dx:GridViewCommandColumn ShowEditButton="True" ShowDeleteButton="true"
                                ShowNewButtonInHeader="true" VisibleIndex="5" HeaderStyle-CssClass="treelist-new-column">
                        ...
                        <SettingsText CommandNew="Yeni" CommandDelete="Sil" CommandCancel="Ləğv et" CommandEdit="Yenilə"
