<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="MechanismProgress.aspx.cs" Inherits="Admin_Pages_MechanismProgress" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlContent" runat="server" CssClass="portlet box blue-madison">
                <div class="portlet-title">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataColumn Caption="Məzmun (AZ)" FieldName="title_az" VisibleIndex="2">
                                <DataItemTemplate>
                                    <%#Config.HtmlRemoval.StripTagsRegex(Eval("title_az").ToParseStr()) %>
                                </DataItemTemplate>
