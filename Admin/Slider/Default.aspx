                ...
                <div class="portlet-body ">
                    ...
                    <dx:ASPxGridView ID="Grid" runat="server"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataComboBoxColumn Caption="Məqsəd" FieldName="goal_id" VisibleIndex="2" Width="200"></dx:GridViewDataComboBoxColumn>
                            <dx:GridViewDataMemoColumn Caption="Başlıq" FieldName="title_az" VisibleIndex="3"></dx:GridViewDataMemoColumn>
                            <dx:GridViewDataCheckColumn Caption="Əsas səhifədə görünəcəkmi?" Width="100" FieldName="show_home_slider" VisibleIndex="3"></dx:GridViewDataCheckColumn>
                            ...
                            <dx:GridViewDataColumn Caption="" Width="70" VisibleIndex="7">
                                <DataItemTemplate>
                                    ...
                                    <asp:LinkButton Text="Sil" runat="server" OnClientClick="return confirm('Silmək istəditinizə əminsiniz?');" ID="delete" OnClick="delete_Click" CommandArgument='<%#Eval("id") %>' />
                                </DataItemTemplate>
